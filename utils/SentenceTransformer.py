...
class SentenceTransformer(nn.Sequential):
    ...
    def __init__(self, model_name_or_path: Optional[str] = None,
        ...
        print("\n\n=========================== rewrite to use encode do train ===========================\n")
    ...
    def encode_for_train(self, sentences: Union[str, List[str]],
                         batch_size: int = 32,
                         show_progress_bar: bool = None,
                         output_value: str = 'sentence_embedding',
                         convert_to_numpy: bool = False,
    ...
    def _load_auto_model(self, model_name_or_path):
        ...
        logger.warning('DO NOT NEED TO WORRY ==================if "gte-" in model_name_or_path or "bge-" in model_name_or_path:======================')
        
        if "gte-" in model_name_or_path or "bge-" in model_name_or_path:
