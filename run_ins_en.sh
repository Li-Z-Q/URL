...
train_data=manual_1K_ins_en
# train_data=manual_1K_no_ins_en
# train_data=manual_1K_single_ins_en
...
deepspeed --master_port=1225 run_ins_en.py \
    --output_dir /ceph_home/XXX/llm_matching/${WANDB_PROJECT}/${WANDB_RUN_NAME} \
    --model_name_or_path /ceph_home/XXX/hf_models/${base_model} \
    --train_data /shared_home/XXX/llm-matching/${train_data}.jsonl \
